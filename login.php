...
<!-- <div class="setPw">
  <div class="pwGuide">
    <div class="pwList">
      <ul>
        <li><span id="pwChar">歡迎來到小水獺</span></li>
        <li><span id="pwLower">請輸入您的帳號密碼</span></li>
        <li><span id="pwCap">若尚未辦理帳號密碼</span></li>
        <li><span id="pwNum">請按右上角建立帳號</span></li>
      </ul>
    </div>
    ...
    <form action="check.php" id="pwSignup" method="post">
      <div class="inp1-account">
      	<center><font size="6" face="Margarine">Login</center><br>
      <input class="inp1" id="account" type="text" name="id" placeholder="學號"/>
    </div>
      <div class="inp-password">
      <input class="inp" id="password" type="password" name="pwd" placeholder="Password"/>
      <div class="hide" id="showPW"></div><br><br>
...
<div class="item button-pulse" style="--bg-color: #e67e22">
    <div class="button__wrapper">
      ...
      <button type="button" onclick="javascript:location.href='addacc.php'">Create!</button>
    </div>
  </div>
